...
for i in range(seq.shape[2] - 1):
    ...
    if(i == 1 or i == 20 or i == 40 or i == 60 or i == 80):
        ...
        plt.savefig('C:/D/CMU/Courses/F23/16-820/hw2/submission/results/girlseq_wcrt_{}'.format(i))

    np.save('C:/D/CMU/Courses/F23/16-820/hw2/submission/data/girlseqrects_wrct.npy', rects)